...
import ai.api.model.v2.response.Fulfillment;
...
public abstract class AIWebhookServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    doWebhook(gson.fromJson(request.getReader(),  ai.api.model.v2.request.AIWebhookRequest.class), output);
   ...
   */
  protected abstract void doWebhook( ai.api.model.v2.request.AIWebhookRequest input, Fulfillment output);
